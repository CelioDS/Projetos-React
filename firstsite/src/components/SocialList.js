    ...
    <section>
      <div>
        ...
        <ul class="social-list">
          <li>
            <a target="_blank" href="https://www.twitch.tv/maykbrito">
              <svg
                width="33"
                height="32"
                viewBox="0 0 33 32"
          ...
          <li>
            <a target="_blank" href="https://www.twitter.com/maykbrito">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
          ...
          <li>
            <a target="_blank" href="https://www.instagram.com/maykbrito">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
          ...
          <li>
            <a target="_blank" href="https://www.youtube.com/maykbrito">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
